...
import '/events/no_events/no_events_widget.dart';
import '/flutter_flow/flutter_flow_theme.dart';
import '/flutter_flow/flutter_flow_util.dart';
import '/home/announcement_create/announcement_create_widget.dart';
import '/home/announcement_edit/announcement_edit_widget.dart';
                ...
                Expanded(
                  child: StreamBuilder<List<UserRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<UserRecord> richTextUserRecordList = snapshot.data!;
                      // Return an empty Container when the item does not exist.
                      if (snapshot.data!.isEmpty) {
                        return Container();
                      }
                      final richTextUserRecord =
                          richTextUserRecordList.isNotEmpty
                              ? richTextUserRecordList.first
                              : null;
                      return RichText(
                        text: TextSpan(
                          children: [
                                          ...
                                          return GestureDetector(
                                            ...
                                            child: Padding(
                                              padding: MediaQuery.of(context)
                                                  .viewInsets,
                                              child: AnnouncementCreateWidget(),
                                            ),
                                          );
                                        },
                                      ).then((value) => setState(() {}));
                              ...
                              child: StreamBuilder<List<AnnouncementRecord>>(
                                stream: queryAnnouncementRecord(
                                  queryBuilder: (announcementRecord) =>
                                      announcementRecord.orderBy('date_created',
                                          descending: true),
                                ),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                  ...
                                  List<AnnouncementRecord>
                                      pageViewAnnouncementRecordList =
                                      snapshot.data!;
                                  return Container(
                                        ...
                                        Padding(
                                          ...
                                          child: PageView.builder(
                                            ...
                                            itemBuilder:
                                              ...
                                              final pageViewAnnouncementRecord =
                                                  pageViewAnnouncementRecordList[
                                                      pageViewIndex];
                                              return Column(
                                                mainAxisSize: MainAxisSize.max,
                                                                          ...
                                                                          builder:
                                                                            ...
                                                                            return GestureDetector(
                                                                              ...
                                                                              child: Padding(
                                                                                ...
                                                                                child: AnnouncementEditWidget(
                                                                                  announcement: pageViewAnnouncementRecord.reference,
                                                                                ),
                                                                              ),
                                                                            );
                                                                          },
                                                                    ...
                                                                    children: [
                                                                      Align(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            pageViewAnnouncementRecord.description,
                                                                            textAlign:
                                                                                TextAlign.start,
                                                                            maxLines:
                                                                                6,
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        dateTimeFormat(
                                            'MMMMEEEEd',
                                            functions.toDayBeginning(functions
                                                .addDaysToDateTime(1))),
                                        textAlign: TextAlign.start,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                                                    ...
                                                                    Column(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                              AutoSizeText(
                                                                            listViewEventRecord.creatorName,
                                                                            textAlign:
                                                                                TextAlign.start,
                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                  fontFamily: 'Readex Pro',
