...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'GroupTemplate',
          path: '/groupTemplate',
          builder: (context, params) => GroupTemplateWidget(
            group: params.getParam(
                'group', ParamType.DocumentReference, false, ['group']),
          ),
        ),
        FFRoute(
          name: 'Account',
        ...
        FFRoute(
          ...
          builder: (context, params) => ParentPortalWidget(
            student: params.getParam(
                'student', ParamType.DocumentReference, false, ['user']),
          ),
        ),
        FFRoute(
          name: 'ReportBugs',
          path: '/reportBugs',
          builder: (context, params) => ReportBugsWidget(),
        ),
        FFRoute(
          name: 'Signup',
          path: '/signup',
