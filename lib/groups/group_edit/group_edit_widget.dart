      ...
      child: Padding(
        ...
        child: StreamBuilder<GroupRecord>(
          ...
          builder: (context, snapshot) {
            ...
            final dropdown1OptionsGroupRecord = snapshot.data!;
            return Container(
              width: 300.0,
              height: 377.0,
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller: _model.textController ??=
                                      ...
                                      text: dropdown1OptionsGroupRecord.title,
                                    ),
                                    autofocus: true,
                                    obscureText: false,
                            ...
                            onTap: () async {
                              final _colorPickedColor = await showFFColorPicker(
                                ...
                                currentColor: _model.colorPicked ??=
                                    dropdown1OptionsGroupRecord.color,
                        ...
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              await widget.group!.update(createGroupRecordData(
